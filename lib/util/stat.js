...
export function checkPaths(src, dest, funcName, opts, cb) {
    callbackify(getStats)(src, dest, opts, (err, stats) => {
...
export function checkParentPaths(src, srcStat, dest, funcName, cb) {
    const srcParent = resolve(dirname(src));
    const destParent = resolve(dirname(dest));
    if (destParent === srcParent || destParent === parse(destParent).root) return cb();
