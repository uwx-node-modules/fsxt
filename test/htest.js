  ...
  describe('xt', () => {
    ...
    describe('.mapStructure', () => {
      beforeEach(async () => {
        ...
        await fs.ensureDir(t + '/brap/e.avi');
        await fs.ensureDir(t + '/brap/e');
    ...
    describe('.vacuum', () => {
      beforeEach(async () => {
        await fs.mkdir(t);
        await fs.ensureDir(t + '/brap/');
        await fs.ensureDir(t + '/brap2/');
        await fs.ensureDir(t + '/brap2/a/b/c/d');
        await fs.ensureDir(t + '/brap2/a/b/d/e');
        await fs.ensureDir(t + '/brap3/');
        await fs.ensureDir(t + '/brap3/zz/41');
        await fs.ensureDir(t + '/brap4/');
        await fs.ensureDir(t + '/brap5/');
        await fs.ensureDir(t + '/brap6/');
        await fs.ensureDir(t + '/brap6/7');
        await fs.ensureDir(t + '/brap6/8/9');
        await fs.ensureDir(t + '/brap6/1/2/3');
        await fs.ensureDir(t + '/brap6/1/4/5');
        await fs.ensureDir(t + '/brap6/1/4/6');
        await fs.ensureDir(t + '/brap6/2/4/7');
        await fs.ensureDir(t + '/brap6/2/4/8/9');
      });
      afterEach(async () => {
        await fs.remove(t);
      });
    ...
    describe('.dive', () => {
      ...
      describe('sync', () => {
        ...
        it('normal functionality', async () => {
          assert.deepEqual(fs.diveSync(t).sort(), paths.sort());
        });
      });
